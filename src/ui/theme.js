...
const DEFINITIONS = {
  default: {
    effects: { palette: ["#c7f36b", "#65e6b4", "#62dce7"], particleCount: 26, tilt: true },
    chart: {
      gradientStart: "#62dce7",
      gradientEnd: "#2a7777",
      opacityStart: 0.82,
      opacityEnd: 0.1,
      radius: 3,
  ...
  stardew: {
    effects: { palette: ["#f4d56d", "#c8e49a", "#9fd1d0"], particleCount: 18, tilt: false },
    chart: {
      gradientStart: "#64af50",
      gradientEnd: "#247443",
      opacityStart: 1,
      opacityEnd: 1,
      radius: 0,
...
export function currentTheme() {
  return DEFINITIONS[currentThemeId()] || DEFINITIONS.default;
}
